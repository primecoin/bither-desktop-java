...
import org.primer.viewsystem.base.ViewSystem;
import org.primer.viewsystem.base.Viewable;
import org.primer.viewsystem.dialogs.PanelDialog;
...
public class MainFrame extends JFrame implements ViewSystem, ApplicationListener {
    ...
    public MainFrame(CoreController coreController, ViewEnum initialView) {
        ...
        ToolTipManager.sharedInstance().setDismissDelay(PrimerSetting.TOOLTIP_DISMISSAL_DELAY);
    ...
    private void remapCommandOnMac() {
        ...
        if (Primer.getGenericApplication() != null && Primer.getGenericApplication().isMac()) {
    ...
    private void sizeAndCenter() {
        ...
        int height = (int) (screenSize.height * PrimerSetting.PROPORTION_OF_VERTICAL_SCREEN_TO_FILL);
        int width = (int) (screenSize.width * PrimerSetting.PROPORTION_OF_HORIZONTAL_SCREEN_TO_FILL);

        // Set the jframe height and width.
        setPreferredSize(new Dimension(width, height));
        double startVerticalPositionRatio = (1 - PrimerSetting.PROPORTION_OF_VERTICAL_SCREEN_TO_FILL) / 2;
        double startHorizontalPositionRatio = (1 - PrimerSetting.PROPORTION_OF_HORIZONTAL_SCREEN_TO_FILL) / 2;
...
//        }
    ...
    public void fireFilesHaveBeenChangedByAnotherProcess(Address perWalletModelData) {
        if (Primer.getActionAddress() != null
                && Primer.getActionAddress().getAddress().equals(perWalletModelData.getAddress())) {
