...
import org.primer.primerj.runnable.EditPasswordThread;
import org.primer.primerj.utils.Utils;
import org.primer.utils.LocaliserUtils;
import org.primer.utils.PasswordStrengthUtil;
...
public class ChangePasswordPanel extends WizardPanel {
    ...
    public class ChangePasswordSubmitAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (currentPassword.getPassword() == null || currentPassword.getPassword().length > PrimerSetting.PASSWORD_LENGTH_MAX
                    || currentPassword.getPassword().length < PrimerSetting.PASSWORD_LENGTH_MIN) {
            ...
            if (newPassword.getPassword() == null || newPassword.getPassword().length > PrimerSetting.PASSWORD_LENGTH_MAX
                    || newPassword.getPassword().length < PrimerSetting.PASSWORD_LENGTH_MIN) {
