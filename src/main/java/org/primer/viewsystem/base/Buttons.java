...
import org.primer.languages.Languages;
import org.primer.languages.MessageKey;
import org.primer.viewsystem.themes.NimbusDecorator;
...
public class Buttons {
    ...
    public static JButton newAlertPanelButton(Action action, MessageKey messageKey, MessageKey tooltipKey, AwesomeIcon icon) {
        ...
        AwesomeDecorator.applyIcon(icon, button, true, PrimerUI.SMALL_ICON_SIZE);
    ...
    public static JButton newYesButton(Action action, AwesomeIcon confirmIcon, boolean isConfirmDangerous) {
        ...
        AwesomeDecorator.applyIcon(confirmIcon, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newNoButton(Action action) {
        ...
        // The icon should trail the text for visual consistency
        AwesomeDecorator.applyIcon(AwesomeIcon.TIMES, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newQRCodeButton(Action action, MessageKey key) {
        ...
        // The icon should trail the text for visual consistency
        AwesomeDecorator.applyIcon(AwesomeIcon.QRCODE, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newFileTextButton(Action action, MessageKey key) {
        ...
        // The icon should trail the text for visual consistency
        AwesomeDecorator.applyIcon(AwesomeIcon.FA_FILE_TEXT, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newFromFileButton(Action action) {
        ...
        // The icon should trail the text for visual consistency
        AwesomeDecorator.applyIcon(AwesomeIcon.FA_FOLDER_OPEN, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newFromCameraButton(Action action) {
        ...
        // The icon should trail the text for visual consistency
        AwesomeDecorator.applyIcon(AwesomeIcon.FA_CAMER, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newUndoButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.UNDO, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newExportButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.FA_SIGN_OUT,
                button, false, JLabel.BOTTOM, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newImportButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.FA_SIGN_IN, button, false, JLabel.BOTTOM, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newSignMessageButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.PENCIL, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newVerifyMessageButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.CHECK, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newClearAllButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.MINUS_CIRCLE, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newDeletePaymentRequestButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.TRASH, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newBackspaceDeleteButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(icon, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static void modifOkButton(JButton button) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.CHECK, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static void modifSendButton(JButton button) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.SEND, button, true, PrimerUI.SMALLER_ICON_SIZE);
        button.setFocusable(false);
    }
    ...
    public static void modifCopyButton(JButton button) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.COPY, button, true, PrimerUI.SMALLER_ICON_SIZE);
        button.setFocusable(false);
    }
    ...
    public static JButton newExitButton(Action action, boolean leading) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.SIGN_OUT, button, leading, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newPreviousButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(icon, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newFinishButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.FLAG_CHECKERED, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newCheckPrivateKeyButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.SHIELD
                , button, false,
                JLabel.BOTTOM, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newUnlockButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.UNLOCK, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newSendButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.CLOUD_UPLOAD, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newRefreshButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.REFRESH, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newHomeButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.HOME, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newCopyButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.COPY, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newCopyAllButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.COPY, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newPasteButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.PASTE, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newOptionsButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.FA_LIST, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newPasteAllButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.PASTE, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newPanelCloseButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.TIMES, button, true, PrimerUI.SMALL_ICON_SIZE);
    ...
    public static JButton newSelectFileButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.FOLDER_OPEN, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newEyeButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.FA_EYE, button,
                false, JLabel.BOTTOM, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newEditButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.EDIT, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newDetailsButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.FILE_TEXT_O, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newSearchButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.SEARCH, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newLaunchBrowserButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.EXTERNAL_LINK, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newPlaySoundButton(Action action, MessageKey key, MessageKey tooltipKey) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.PLAY, button, true, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newRestoreButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.MAGIC, button, false, PrimerUI.NORMAL_ICON_SIZE);
    ...
    public static JButton newSendBitcoinWizardButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.CLOUD_UPLOAD, button, true, JLabel.BOTTOM, PrimerUI.LARGE_ICON_SIZE);
    ...
    public static JButton newRequestBitcoinWizardButton(Action action) {
        ...
        AwesomeDecorator.applyIcon(AwesomeIcon.CLOUD_DOWNLOAD, button, true, JLabel.BOTTOM, PrimerUI.LARGE_ICON_SIZE);
