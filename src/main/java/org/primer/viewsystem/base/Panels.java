...
import org.primer.viewsystem.components.ImageDecorator;
import org.primer.viewsystem.panels.BackgroundPanel;
import org.primer.viewsystem.panels.LightBoxPanel;
import org.primer.viewsystem.panels.RoundedPanel;
...
public class Panels {
    ...
    public static BackgroundPanel newDetailBackgroundPanel(AwesomeIcon icon) {
        ...
        panel.setAlpha(PrimerUI.DETAIL_PANEL_BACKGROUND_ALPHA);
    ...
    public synchronized static void showLightBox(JPanel panel) {
        ...
        // Prevent focus
        allowFocus(Primer.getMainFrame(), false);
    ...
    public synchronized static void hideLightBoxIfPresent() {
        ...
        // Finally allow focus
        allowFocus(Primer.getMainFrame(), true);
