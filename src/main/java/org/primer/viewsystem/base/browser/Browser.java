 ...
 */
package org.primer.viewsystem.base.browser;
...
public class Browser extends javax.swing.JEditorPane {
    ...
    public Browser(String currentHref) {
        ...
        try {
            ...
            addHyperlinkListener(new ActivatedHyperlinkListener(Primer.getMainFrame(), this));
    ...
    public static String getLoadingMessage(String href, String loadingMessage) {
        return href + PrimerSetting.THREE_SPACER + loadingMessage + "...";
    }
