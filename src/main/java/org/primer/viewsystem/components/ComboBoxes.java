...
package org.primer.viewsystem.components;
...
public class ComboBoxes {
    ...
    public static <T> JComboBox<T> newComboBox(T[] items) {
        ...
        comboBox.setMinimumSize(new Dimension(25, PrimerUI.NORMAL_ICON_SIZE + 14));
    ...
    public static JComboBox<MarketUtil.MarketTypeMode> newExchangeRateProviderComboBox(ActionListener listener) {
        ...
        comboBox.setMaximumRowCount(PrimerUI.COMBOBOX_MAX_ROW_COUNT);
