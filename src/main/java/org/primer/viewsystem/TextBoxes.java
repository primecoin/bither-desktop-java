...
import org.primer.utils.DocumentMaxLengthFilter;
import org.primer.viewsystem.base.AccessibilityDecorator;
import org.primer.viewsystem.components.borders.TextBubbleBorder;
...
public class TextBoxes {
    ...
    public static JTextField newEnterTransactionLabel() {
        ...
        JTextField textField = newTextField(PrimerUI.RECEIVE_ADDRESS_LABEL_LENGTH);
        ...
        // Limit the length of the underlying document
        DefaultStyledDocument doc = new DefaultStyledDocument();
        doc.setDocumentFilter(new DocumentMaxLengthFilter(PrimerUI.RECEIVE_ADDRESS_LABEL_LENGTH));
    ...
    public static JPasswordField newPassword() {
        ...
        JPasswordField passwordField = new JPasswordField(PrimerUI.PASSWORD_LENGTH);
        ...
        // Limit the length of the underlying document
        DefaultStyledDocument doc = new DefaultStyledDocument();
        doc.setDocumentFilter(new DocumentMaxLengthFilter(PrimerUI.PASSWORD_LENGTH));
    ...
    public static JTextArea newEnterNotes(DocumentListener listener) {
        ...
        JTextArea textArea = TextBoxes.newEnterPrivateNotes(listener, PrimerUI.PASSWORD_LENGTH);
    ...
    public static JTextArea newEnterMessage() {
        ...
        JTextArea textArea = new JTextArea(4, PrimerUI.PASSWORD_LENGTH);
    ...
    public static JTextArea newEnterPrivateNotes(DocumentListener listener) {
        return TextBoxes.newEnterPrivateNotes(listener, PrimerUI.PASSWORD_LENGTH);
    }
    ...
    public static JTextArea newEnterPrivateNotes(DocumentListener listener, int width) {
        ...
        // Limit the length of the underlying document
        DefaultStyledDocument doc = new DefaultStyledDocument();
        doc.setDocumentFilter(new DocumentMaxLengthFilter(PrimerUI.SEED_PHRASE_LENGTH));
        textArea.setDocument(doc);
    ...
    public static JTextArea newEnterSeedPhrase() {
        ...
        JTextArea textArea = new JTextArea(doc, "", 6, PrimerUI.PASSWORD_LENGTH);
