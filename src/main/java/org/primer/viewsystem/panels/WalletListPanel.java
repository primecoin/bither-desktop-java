...
import org.primer.viewsystem.froms.HDMColdAccountForm;
import org.primer.viewsystem.froms.IAddressForm;
import org.primer.viewsystem.froms.SingleColdWalletFrom;
                ...
                for (IAddressForm loopSingleWalletPanel : walletPanels) {
                    ...
                    if (loopSingleWalletPanel.getOnlyName() != null) {
                        if (Utils.compareString(loopSingleWalletPanel.getOnlyName(), address)) {
                            Primer.setActivePerWalletModelData(loopSingleWalletPanel.getPerWalletModelData());
...
//        }
        ...
        Primer.getMainFrame().getMainFrameUi().calculateDividerPosition();
    }
