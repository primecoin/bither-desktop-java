...
package org.primer.viewsystem.panels;
...
public class LightBoxPanel extends JPanel {
    ...
    public LightBoxPanel(JPanel screenPanel, Integer layer) {
        ...
        setSize(Primer.getMainFrame().getWidth() + 100, Primer.getMainFrame().getHeight() + 100);
        ...
        if (JLayeredPane.MODAL_LAYER.equals(layer)) {
            Primer.getMainFrame().getLayeredPane().add(this, JLayeredPane.PALETTE_LAYER);
        } else {
            Primer.getMainFrame().getLayeredPane().add(this, JLayeredPane.POPUP_LAYER);
        }
        ...
        Primer.getMainFrame().getLayeredPane().add(screenPanel, layer);
    ...
    private void calculatePosition() {
        ...
        int currentFrameWidth = Primer.getMainFrame().getWidth();
        int currentFrameHeight = Primer.getMainFrame().getHeight();
    ...
    public void close() {
        ...
        JLayeredPane layeredPane = Primer.getMainFrame().getLayeredPane();
        ...
        // Repaint
        Primer.getMainFrame().validate();
        Primer.getMainFrame().repaint();
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        g.fillRect(0, 0, Primer.getMainFrame().getWidth(), Primer.getMainFrame().getHeight());
