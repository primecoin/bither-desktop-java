...
package org.primer.viewsystem;

import org.primer.Primer;
import org.primer.PrimerSetting;
import org.primer.platform.listener.GenericQuitEventListener;
import org.primer.platform.listener.GenericQuitResponse;
...
import org.primer.utils.ImageLoader;
import org.primer.utils.LocaliserUtils;
import org.primer.viewsystem.base.DisplayHint;
import org.primer.viewsystem.base.ViewEnum;
import org.primer.viewsystem.base.Viewable;
import org.primer.viewsystem.components.ScrollBarUIDecorator;
import org.primer.viewsystem.froms.MenuBar;
import org.primer.viewsystem.froms.SingleWalletForm;
...
public class MainFrameUI {
    ...
    public void initUI(ViewEnum initialView) {
        ...
        ImageIcon imageIcon = ImageLoader.createImageIcon(ImageLoader.PRIMER_ICON_FILE);
        if (imageIcon != null) {
    ...
    public void calculateDividerPosition() {
        int dividerPosition = SingleWalletForm.calculateNormalWidth(walletsView) + PrimerSetting.WALLET_WIDTH_DELTA;
...
//        }
    ...
    public void recreateAllViewsOnSwingThread(final boolean initUI, ViewEnum initialView) {
        ...
        if (Primer.getCoreController().getCurrentView() != ViewEnum.UNKNOWN_VIEW) {
            frame.navigateAwayFromView(Primer.getCoreController().getCurrentView());
        }
    ...
    public void fireDataChangedOnSwingThread(DisplayHint displayHint) {
        ...
        Viewable currentViewView = viewFactory.getView(Primer.getCoreController().getCurrentView());
