...
public class SignTxDialg extends PrimerDialog implements IDialogPasswordListener {
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        dp.dispose();
                        dispose();
                        DisplayPrimerQRCodePanel displayBitherQRCodePanle = new DisplayPrimerQRCodePanel(r);
