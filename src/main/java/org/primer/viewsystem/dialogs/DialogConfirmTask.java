...
public class DialogConfirmTask extends PrimerDialog {
    ...
    public DialogConfirmTask(CharSequence message,
        ...
        ViewUtil.setDimension(contentPane, new Dimension(PrimerUI.WIZARD_MIN_WIDTH, PrimerUI.SIDEBAR_LHS_PREF_WIDTH));
        initDialog();
    }
