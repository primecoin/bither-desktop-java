...
public class FileUtil {
    ...
    public static final String USER_PROPERTIES_FILE_NAME = "primer.properties";
    ...
    private static File getDir(String name) {
        File file = new File(Primer.getApplicationDataDirectoryLocator().getApplicationDataDirectory() + File.separator + name);
        if (!file.exists()) {
            file.mkdirs();
        }
        return file;
    ...
    public static Properties loadUserPreferences(String fileName) {
        ...
        try {
            ...
            if ("".equals(Primer.getApplicationDataDirectoryLocator().getApplicationDataDirectory())) {
                userPropertiesFilename = fileName;
            } else {
                userPropertiesFilename = Primer.getApplicationDataDirectoryLocator().getApplicationDataDirectory() + File.separator
                        + fileName;
            }
    ...
    public static void saveUserPreferences(Properties userPreferences, String fileName) {
        ...
        try {
            ...
            if ("".equals(Primer.getApplicationDataDirectoryLocator().getApplicationDataDirectory())) {
                ...
                userPropertiesFilename = Primer.getApplicationDataDirectoryLocator().getApplicationDataDirectory()
            ...
            userPreferences.store(outputStreamWriter, PrimerSetting.USER_PROPERTIES_HEADER_TEXT);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
