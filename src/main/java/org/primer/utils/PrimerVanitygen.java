...
public class PrimerVanitygen {
    ...
    private PrimerSetting.ECKeyType ecKeyType;

    public PrimerVanitygen(String input, boolean useOpencl, boolean igoreCase, int threadNum
            , PrimerSetting.ECKeyType ecKeyType,
    ...
    public void generateAddress() {
        ...
        if (!OSUtils.isWindows() || !SystemUtil.isSystem32()) {
            if (ecKeyType == PrimerSetting.ECKeyType.UNCompressed) {
