...
public interface PrimerUI {
     ...
     */
    String WIZARD_MAX_WIDTH_MIG = "wmax " + (PrimerUI.WIZARD_MIN_WIDTH - 30);

    String WIZARD_MAX_WIDTH_SEED_PHRASE_MIG = "width 300:300:" + (PrimerUI.WIZARD_MIN_WIDTH - 30);
