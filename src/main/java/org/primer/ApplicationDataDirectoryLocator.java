...
import org.primer.utils.FileUtil;
    ...
    public String getApplicationDataDirectory() {
        ...
        if (propertiesFile.exists()) {
            ...
            if (operatingSystemName != null && operatingSystemName.startsWith("Windows")) {
                // Windows os
                applicationDataDirectory = System.getenv("APPDATA") + File.separator + PrimerSetting.MAIN_DIR;
            } else {
                if (operatingSystemName != null && operatingSystemName.startsWith("Mac")) {
                    ...
                    if ((new File("../../../../" + FileUtil.USER_PROPERTIES_FILE_NAME)).exists()) {
                        ...
                        applicationDataDirectory = System.getProperty("user.home") + "/Library/Application Support/" + PrimerSetting.MAIN_DIR;
                    }
                } else {
                    // treat as Linux/ unix variant
                    applicationDataDirectory = System.getProperty("user.home") + "/" + PrimerSetting.MAIN_DIR;
                }
            }
