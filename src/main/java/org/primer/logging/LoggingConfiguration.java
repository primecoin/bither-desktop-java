...
public class LoggingConfiguration {
    ...
    public LoggingConfiguration() {
        if (PrimerjSettings.LOG_DEBUG) {
            loggers.put("org.primer", Level.DEBUG);
        } else {
            loggers.put("org.primer", Level.INFO);
        }
    ...
    public static class FileConfiguration {
        ...
        private static String CONSOLE_OUTPUT_FILENAME = "primer.log";
        ...
        private String archivedLogFilenamePattern = OUTPUT_DIRECTORY + "/primer-%d.log.gz";
