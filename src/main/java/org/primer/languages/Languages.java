...
public class Languages {
    ...
    public static String[] getCurrencySeparators(boolean forGrouping) {
        ...
        if (forGrouping) {
            ...
            return new String[]{
                    safeText(MessageKey.DECIMAL_COMMA),
                    safeText(MessageKey.DECIMAL_POINT),
                    safeText(MessageKey.DECIMAL_SPACE)
            };
        } else {
    ...
    public static String truncatedList(Collection<String> contents, int maxLength) {
        ...
        String joinedContents = Joiner
                .on(safeText(MessageKey.LIST_COMMA) + " ")
                .join(contents);

        String ellipsis = safeText(MessageKey.LIST_ELLIPSIS);
