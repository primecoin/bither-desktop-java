...
package org.primer.fonts;

import com.google.common.base.Preconditions;
import org.primer.PrimerUI;
import org.primer.exception.UIException;
...
public class AwesomeDecorator {
    ...
    static {
        ...
        try {
            InputStream in = AwesomeDecorator.class.getResourceAsStream("/fonts/FontAwesome-4.2.0.ttf");
            AWESOME_FONT = Font.createFont(Font.TRUETYPE_FONT, in);

            Preconditions.checkNotNull(AWESOME_FONT, "Font Awesome not loaded");

            AWESOME_FONT = AWESOME_FONT.deriveFont(Font.PLAIN, PrimerUI.NORMAL_ICON_SIZE);
