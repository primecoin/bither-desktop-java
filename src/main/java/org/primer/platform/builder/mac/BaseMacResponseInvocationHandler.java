 ...
 */
package org.primer.platform.builder.mac;

import org.primer.platform.handler.GenericHandler;
import org.primer.platform.listener.GenericEvent;
import org.primer.platform.listener.GenericQuitEvent;
 ...
 * <li><code>E</code>: The generic event class (e.g. {@link GenericQuitEvent}</li>
 * <li><code>R</code>: The generic response class (e.g. {@link GenericQuitResponse}</li>
 * </ul>
 *
 * @since 0.3.0
 */
public abstract class BaseMacResponseInvocationHandler<H extends GenericHandler, E extends GenericEvent, R extends GenericEvent> implements InvocationHandler {
    ...
    /**
     * <p>Create a proxy instance of {@link GenericEvent}
