...
public final class ApplicationInstanceManager {
    ...
    public static boolean registerInstance(String rawURI) {
        ...
        // return false
        try {
            final ServerSocket socket = new ServerSocket(PrimerjSettings.PRIMER_DESKTOP_NETWORK_SOCKET, 10, InetAddress.getByAddress(new byte[]{127, 0,
                    0, 1}));
            ...
            try {
                Socket clientSocket = new Socket(InetAddress.getByAddress(new byte[]{127, 0, 0, 1}), PrimerjSettings.PRIMER_DESKTOP_NETWORK_SOCKET);
    ...
    public static void setApplicationInstanceListener(ApplicationDataDirectoryLocator.ApplicationInstanceListener listener) {
