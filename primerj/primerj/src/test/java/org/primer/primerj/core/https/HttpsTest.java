...
public class HttpsTest {
    ...
    private static final String TrustStorePassword = "primer";

    @Test
    public void testCreateHDAddress() throws Exception {
        trust();
        try {
            String getRespon = ConnectHttps.httpGet("https://hdm.primer.net/api/v1/1C6FiRktL3UPd4sywhyU5CYSeLdKhvHxhR/hdm/password");
