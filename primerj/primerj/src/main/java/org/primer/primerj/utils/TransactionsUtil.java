...
import org.primer.primerj.api.BitherMytransactionsApi;
...
//                int txIndex = txJSON.getInt(BLOCK_CHAIN_TX_INDEX);
    ...
    public static void getMyTxFromBither() throws Exception {
        ...
        // TODO: web type
        int flag = AbstractApp.primerjSetting.getApiConfig().value();
...
//                    hasTx = false;
                ...
                while (needGetTxs) {
                    // TODO: get data from primer.net else from blockchain.info
                    if (webType == 0) {
