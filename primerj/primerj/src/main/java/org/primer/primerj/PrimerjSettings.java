...
public class PrimerjSettings {
    ...
    public static final int PRIMER_DESKTOP_NETWORK_SOCKET = 8329;
    public static final int PRIMER_ENTERPRISE_NETWORK_SOCKET = 8328;
    public static final int PRIMER_DAEMON_NETWORK_SOCKET = 8327;
...
//            "primecoin.net",        // Pieter Wuille
            "seed.primecoin.org",         // Matt Corallo
