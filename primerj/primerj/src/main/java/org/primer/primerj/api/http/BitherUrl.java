...
public class BitherUrl {
    public static final class BITHER_DNS {
        ...
        public static final String BITHER_BC_DOMAIN = "bc.primer.net";
        public static final String BITHER_HDM_DOMAIN = "hdm.primer.net";
        ...
        public static final String BITHER_URL = Utils.format(FORMAT_HTTP, "primer.net");
