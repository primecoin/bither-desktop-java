...
//    }
    ...
    public Out(Tx parent, long value, byte[] scriptBytes) {
        ...
        checkArgument(value < PrimerjSettings.MAX_MONEY, "Values larger than MAX_MONEY not allowed");
        this.outValue = value;
        this.outScript = scriptBytes;
        this.tx = parent;
        this.txHash = this.tx.getTxHash();
...
//    Tx parentTransaction;
     ...
     * <p/>
     * <p>You probably should use {@link Out#getMinNonDustValue()} which uses
     ...
     *                         If you want a safe default, use {@link Tx#REFERENCE_DEFAULT_MIN_TX_FEE}*3
     */
